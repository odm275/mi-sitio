...
The challenge here was to collect user information through different pages and form a cohesive way to representing that through state.
A flux like store would fit my use case the best.
