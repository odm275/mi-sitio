...
If I send the wrong input the server, typescript will not let me.
...
For **_Mise_**, I mostly stuck with strategies 1 and 3. Most queries in Mise are light enough to not cause performance issues if re-fetched. Furthermore,
...
Give example here? Talk about thought consideration between use reducer and state machines
