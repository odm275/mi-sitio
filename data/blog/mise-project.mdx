...
Overall, trpc had the best trade offs for this application. The cons are all negible in this instance, and I get to reap all the pros. Alas,
I have a safe way to call my backend from my frontend, and I get top tier automatic intellisense. Thus, the values fast, nimble, efficient, and reliable
that I'm looking to get are preserved.

#### Next.js vs Custom Backend

#### Auth0

In the spirit of focusing my time in actually building the application, and being fast and nimble, I went with Auth0. I had everything having to do with
